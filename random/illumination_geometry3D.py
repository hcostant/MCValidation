...
class Geometry:
    ...
    def plot_pixels(self):
        ...
        # print(pix_x.shape, pix_cy.shape, module_centers.shape)
    ...
    def plot_camera(self): #TPA
        ...
        # disp.image = image
        patches = []
        for ipix in range(len(self.geom.pix_x)):
            aa = self.geom.pix_area[ipix]
            rr = sqrt(aa*2/2/sqrt(3)) + 2 * PIXEL_EPSILON
            poly - RegularPolygon
